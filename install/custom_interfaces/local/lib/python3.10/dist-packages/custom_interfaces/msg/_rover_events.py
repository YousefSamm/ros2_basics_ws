...
class RoverEvents(metaclass=Metaclass_RoverEvents):
    ...
    _fields_and_field_types = {
        'info': 'std_msgs/String',
        'rover_location': 'geometry_msgs/Pose',
    }
    ...
    def __init__(self, **kwargs):
        ...
        from std_msgs.msg import String
        self.info = kwargs.get('info', String())
        from geometry_msgs.msg import Pose
        self.rover_location = kwargs.get('rover_location', Pose())
    ...
    def __eq__(self, other):
        ...
        if self.info != other.info:
            return False
        if self.rover_location != other.rover_location:
            return False
        return True
    ...
    def info(self, value):
        if __debug__:
            ...
            assert \
                ...
                "The 'info' field must be a sub message of type 'String'"
        self._info = value

    @builtins.property
    def rover_location(self):
        """Message field 'rover_location'."""
        return self._rover_location

    @rover_location.setter
    def rover_location(self, value):
        if __debug__:
            from geometry_msgs.msg import Pose
            assert \
                isinstance(value, Pose), \
                "The 'rover_location' field must be a sub message of type 'Pose'"
        self._rover_location = value
